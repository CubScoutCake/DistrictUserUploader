...
//jQuery v 3.0
echo $this->Html->script('https://code.jquery.com/jquery-3.2.1.slim.min.js', ['integrity' => 'sha384-KJ3o2DKtIkvYIK3UENzmM7KCkRr/rE9/Qpg6aAZGJwFDMVNA/GpGFF93hXpG5KkN', 'crossorigin' => 'anonymous']);
...
echo $this->Html->script('https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.3/umd/popper.min.js', ['integrity' => 'sha384-vFJXuSJphROIrBnz7yo7oB41mKfc8JzQZiCq4NCceLEaO4IHwicKwpJf9c9IpFgh', 'crossorigin' => 'anonymous']);
echo $this->Html->script('https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-beta.2/js/bootstrap.min.js', ['integrity' => 'sha384-alpBpkh1PFOepccYVYDB4do5UnbKysX5WZXm3XxPqe5iKTfUKjNkCk9SaVuEZflJ', 'crossorigin' => 'anonymous']);
...
// Font Awesome CDN
echo $this->Html->script('https://use.fontawesome.com/687b7f2021.js');

// Custom Theme JavaScript
//echo $this->Html->script('sb-admin-2.js');

echo $this->Html->script('https://unpkg.com/popper.js');
