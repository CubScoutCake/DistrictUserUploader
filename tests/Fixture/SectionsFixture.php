...
class SectionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'sections_scout_group_id' => ['type' => 'foreign', 'columns' => ['scout_group_id'], 'references' => ['scout_groups', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'sections_section_type_id' => ['type' => 'foreign', 'columns' => ['section_type_id'], 'references' => ['section_types', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
